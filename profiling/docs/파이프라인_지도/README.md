...
|---|---|---|---|
| 2026-09-25 | [2026-09-25.md](2026-09-25.md) | 접수 단계 중복 판정 — Backend가 같은 sourceVersion으로 최대 2회 재전송(09-25 합의)에 맞춰 analyze/resend/skip으로 갈라짐 | 배포 구성(Dockerfile · compose `ai-app`) |
| 2026-09-23 | [2026-09-23.md](2026-09-23.md) | 패키지 평탄화(6폴더 13모듈 → 1폴더 11모듈) + 저장소 PostgreSQL 전용 + 상품 카탈로그 DB 적재(4,231건) + 구현 전체 시퀀스 6장 + 재고 3값 | Backend ID 회신 받아 `--id-map` → 7.9 export로 재고·조회수 채우기 |
